...
//		}
	  ...
	  if ($this->io_method() == 'socket') {
		...
		// $response_timeout set to 200 instead of 30
	...
	*/
	function serialize_return() {
		...
		if ($this->wsdl) {
			...
			$this->debug('do not have WSDL for serialization: assume rpc/literal');
			$payload = '<ns1:'.$this->methodname.'Response xmlns:ns1="'.$this->methodURI.'">'.$return_val.'</ns1:'.$this->methodname."Response>";
		}
...
class wsdl extends nusoap_base {
	...
	* @param string $use (literal|literal) optional The use for the parameters (cannot mix right now)
	* @param string $documentation optional The description to include in the WSDL
	* @param string $encodingStyle optional (usually 'http://schemas.xmlsoap.org/soap/encoding/' for literal)
	* @access public 
	*/
